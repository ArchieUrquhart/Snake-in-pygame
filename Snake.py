...
#initialize window 
screenSize = int(input("Input desired screen size in pixels:	"))
...
print("Congratulations! You got a length of {0}!".format(size+1))